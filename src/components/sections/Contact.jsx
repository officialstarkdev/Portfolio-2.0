        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8 section-animate">
            ...
            <div className="flex gap-4">
              <a href="https://github.com/officialstarkdev" target="_blank" rel="noopener noreferrer" className="glass w-12 h-12 rounded-xl flex items-center justify-center hover:border-indigo-500/50 transition-colors">
              ...
              <a href="http://www.linkedin.com/in/talha-shahid-007b513bb" target="_blank" rel="noopener noreferrer" className="glass w-12 h-12 rounded-xl flex items-center justify-center hover:border-indigo-500/50 transition-colors">
                <svg className="w-5 h-5 text-slate-300" fill="currentColor" viewBox="0 0 24 24">
